...
\end{itemize}
\addcontentsline{toc}{subsection}{Float point ALU} 
...
\end{table}
\addcontentsline{toc}{subsection}{Float point addition and subtraction} 
...
\begin{figure}[htb!]
    \centering
    \includegraphics[width=0.8\linewidth]{FSM_ADDER.png}
    \caption{FSM FP addition or subtraction}
    \label{fig:FPa}
\end{figure}
\addcontentsline{toc}{subsection}{Float point class} 
...
\newline
\newline
\addcontentsline{toc}{subsection}{Float point division} 
...
\begin{figure}[htb!]
    \centering
    \includegraphics[width=0.8\linewidth]{FPDIV_FSM.png}
...
\newline
\newline
\addcontentsline{toc}{subsection}{Float point square root} 
...
\begin{figure}[htb!]
    \centering
    \includegraphics[width=0.6\linewidth]{FSM_SQRT.png}
    \caption{FSM square root}
    \label{fig:FSMsq}
\end{figure}
\addcontentsline{toc}{subsection}{Float point three operand instructions} 
...
\begin{figure}
    \centering
    \includegraphics[width=0.85\linewidth]{threeoperands.png}
    \caption{Additional logic for three operands}
    \label{fig:ThreeOp}
\end{figure}

\addcontentsline{toc}{subsection}{Float point conclusion} 
