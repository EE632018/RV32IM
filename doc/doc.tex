...
\newpage
\addcontentsline{toc}{subsection}{Implementation of Pre-Adder} 
\subsection*{Implementation of Pre-Adder}
...
\begin{figure}[htb!]
    ...
    \label{fig:preadder}
\end{figure}
\addcontentsline{toc}{subsection}{Implementation of Adder} 
\subsection*{Implementation of Adder}
